...
use wpWax\DA\DA_Helpers;

if ( ! defined( 'ABSPATH' ) ) {
	exit;
}

$announcements = DA_Helpers::get_announcements();
?>
...
<div class="directorist-announcement-wrapper">
	...
	<?php else : ?>
		...
		<p class="directorist_not-found"><?php esc_html_e( 'No announcements found', 'directorist-announcement' ); ?></p>
